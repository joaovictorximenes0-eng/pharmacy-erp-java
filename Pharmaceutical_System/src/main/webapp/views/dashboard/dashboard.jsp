...
<%
    ...
    String totalRevenueFormatted = String.format(java.util.Locale.US, "%,.2f", totalRevenue)
...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/css/dashboard-unificado.css">
    <script src="https://cdn.jsdelivr.net/npm/chart.js"></script>
    <script defer src="${pageContext.request.contextPath}/js/dashboard-unificado.js"></script>
</head>
<body>
    <div class="dashboard-page">
        <header class="dashboard-topbar">
            ...
            <div class="dashboard-userbox">
                ...
                <span><%= logado.getPerfil() %></span>
                <a href="${pageContext.request.contextPath}/LogoutServlet" class="btn btn-danger">Sair</a>
            </div>
        </header>
            ...
            <section class="dashboard-main">
                <div class="kpi-grid">
                    <article class="kpi-card">
                        ...
                        <strong class="kpi-value"><%= totalSales %></strong>
                        <small class="kpi-hint">Quantidade total registrada</small>
                    </article>
                    <article class="kpi-card">
                        <span class="kpi-label">Faturamento</span>
                        <strong class="kpi-value">R$ <%= totalRevenueFormatted %></strong>
                        <small class="kpi-hint">Total acumulado</small>
                    </article>
                    <article class="kpi-card">
                        <span class="kpi-label">Estoque baixo</span>
                        <strong class="kpi-value"><%= totalEstoqueBaixo != null ? totalEstoqueBaixo : 0 %></strong>
                        <small class="kpi-hint">Produtos abaixo do mínimo</small>
                    </article>
                    <article class="kpi-card">
                        <span class="kpi-label">Fornecedores</span>
                        <strong class="kpi-value"><%= totalFornecedores != null ? totalFornecedores : 0 %></strong>
            ...
            <aside class="dashboard-aside">
                <section class="panel-card">
                    ...
                    <div class="action-grid">
                        <a href="${pageContext.request.contextPath}/home.jsp" class="btn btn-ghost">Home</a>
                        <a href="${pageContext.request.contextPath}/ReportServlet?action=estoque-completo-pdf" class="btn btn-primary">Estoque PDF</a>
                        <a href="${pageContext.request.contextPath}/ReportServlet?action=estoque-completo-csv" class="btn btn-success">Estoque CSV</a>
                        <a href="${pageContext.request.contextPath}/ReportServlet?action=estoque-baixo-pdf" class="btn btn-primary">Estoque baixo PDF</a>
                        <a href="${pageContext.request.contextPath}/ReportServlet?action=estoque-baixo-csv" class="btn btn-success">Estoque baixo CSV</a>
                        <a href="${pageContext.request.contextPath}/ReportServlet?action=compras-pdf" class="btn btn-primary">Compras PDF</a>
                        <a href="${pageContext.request.contextPath}/ReportServlet?action=compras-csv" class="btn btn-success">Compras CSV</a>
                        <a href="${pageContext.request.contextPath}/ReportServlet?action=fornecedores-pdf" class="btn btn-primary">Fornecedores PDF</a>
                        <a href="${pageContext.request.contextPath}/ReportServlet?action=fornecedores-csv" class="btn btn-success">Fornecedores CSV</a>
                    </div>
                </section>
                ...
                <section class="panel-card compact-info">
                    ...
                    <div class="info-row">
                        <span>Compras</span>
                        <strong><%= totalCompras != null ? totalCompras : 0 %></strong>
                    </div>
                    <div class="info-row">
                        <span>Estoque baixo</span>
                        <strong><%= totalEstoqueBaixo != null ? totalEstoqueBaixo : 0 %></strong>
                    </div>
                    <div class="info-row">
                        <span>Fornecedores</span>
                        <strong><%= totalFornecedores != null ? totalFornecedores : 0 %></strong>
                    </div>
                </section>
            </aside>
        </main>
    ...
    <script>
        window.dashboardData = {
            payment: {
                ...
                values: [<%= dataPayment.toString() %>]
            },
            products: {
                labels: [<%= labelsProducts.toString() %>],
                values: [<%= dataProducts.toString() %>]
            },
            day: {
                labels: [<%= labelsDay.toString() %>],
                values: [<%= dataDay.toString() %>]
            },
            month: {
                labels: [<%= labelsMonth.toString() %>],
                values: [<%= dataMonth.toString() %>]
            },
            year: {
                labels: [<%= labelsYear.toString() %>],
                values: [<%= dataYear.toString() %>]
            }
        };
    </script>
</body>
