...
<body>
	...
	<main style="padding: 20px;">
		...
		<div class="alerta-box">
			⚠️
			<%=request.getAttribute("mensagem")%></div>
		<%
		}
		%>
		...
		<div style="display: flex; gap: 10px; margin-bottom: 20px;">
			<a href="ProductServlet" class="btn">Todos os Produtos</a> <a
				href="ProductServlet?action=estoqueBaixo" class="btn btn-desativar">⚠️
				Estoque Baixo</a>
			<%
			if (temAcesso) {
			%>
			<a href="ProductServlet?action=novo" class="btn btn-novo">➕ Novo
				Produto</a>
			<%
			}
			%>
